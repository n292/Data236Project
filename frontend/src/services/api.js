...
const MESSAGING_API = process.env.REACT_APP_MESSAGING_API || 'http://localhost:3004/api/messaging';
const CONNECTION_API = process.env.REACT_APP_CONNECTION_API || 'http://localhost:3005/api/connections';
