      ...
      <div className="composer-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="composer-modal-toolbar">
          <div className="composer-modal-tools">
            <button title="Photo" style={{ color: '#378fe9' }}>{'\uD83D\uDCF7'}</button>
...
// ====== HOME PAGE ======
const HomePage = ({ currentUserName = 'Rajesh Paruchuri' }) => {
  const toast = useToast();
    ...
    <div className="home-page">
      ...
      <div className="home-sidebar-left">
        ...
        <div className="recent-card">
          <h4>Recent</h4>
          <ul>
            <li>{'\uD83D\uDC65'} Distributed Systems SJSU</li>
            <li>{'\uD83D\uDCBC'} Software Engineering Jobs</li>
            <li>{'\uD83D\uDCAC'} Kafka & Event Streaming</li>
            <li>{'\uD83D\uDE80'} Startup Founders Network</li>
          </ul>
        </div>
      </div>
      ...
      <div className="home-feed">
        <div className="composer-card">
          <div className="composer-top">
            <div className="composer-avatar">{currentUserName.charAt(0)}</div>
      ...
      <div className="home-sidebar-right">
        <div className="news-card">
          <h3>LinkedIn News</h3>
          <ul>
            <li><div className="news-title">Tech hiring rebounds in Q2 2026</div><div className="news-meta">18h ago &#183; 4,521 readers</div></li>
            <li><div className="news-title">Kafka 4.0 drops ZooKeeper dependency</div><div className="news-meta">1d ago &#183; 12,103 readers</div></li>
            <li><div className="news-title">Redis introduces new caching modes</div><div className="news-meta">1d ago &#183; 8,920 readers</div></li>
            <li><div className="news-title">MongoDB Atlas expands free tier</div><div className="news-meta">2d ago &#183; 6,341 readers</div></li>
            <li><div className="news-title">Microservices vs Monolith: 2026 trend</div><div className="news-meta">3d ago &#183; 15,678 readers</div></li>
          </ul>
